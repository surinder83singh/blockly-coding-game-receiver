...
game.createScene('Game', {
    ...
    init: function() {
        ...
        this.cursor = game._cursor = new game.Cursor();
    ...
    start: function() {
        ...
        this.statusText.setText('READY', function() {
            ...
            me.statusText.setText('SET', function() {
                game.scene.grid.updateCursorPosition(function(){
                    console.log("start: updateCursorPosition", arguments)
                    game.audio.playSound('count');
                    ...
                    me.statusText.setText('GO!', function() {
                        ...
                        game.scene.cursor.show();
                        $(document.body).trigger("game-state-changed", {running: true});
                    });
                })
            });
        });
    ...
    endGame: function() {
        $(document.body).trigger("game-state-changed", {running: false});
...
game.createScene('Title', {
    init: function() {
        ...
        var logo = new game.Logo(game.system.height / 2 - 100);
        ...
        this.addTimer(3000, this.startGame.bind(this));
    },
